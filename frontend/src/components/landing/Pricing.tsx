      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-3">
        {cards.map((plan, i) => (
          <Reveal key={plan.name} delay={i * 0.08}>
            <div className="flex h-full flex-col rounded-3xl border border-border bg-card p-7 shadow-elevation-1">
              <h3 className="font-serif text-2xl font-black text-foreground">{plan.name}</h3>
              ...
              <Link
                ...
                className="mt-8 inline-flex items-center justify-center rounded-xl bg-primary px-5 py-3 text-sm font-bold text-primary-foreground hover:bg-primary/90"
              >
