...
export default function RootError({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-night p-6 text-brand-cream">
      <section className="w-full max-w-md rounded-3xl border border-brand-cream/10 bg-brand-cream/[0.03] p-8 text-center">
