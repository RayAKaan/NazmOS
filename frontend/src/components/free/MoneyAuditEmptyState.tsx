...
export function MoneyAuditEmptyState() {
  return (
    <section className="overflow-hidden rounded-3xl border border-white/10 bg-brand-night text-white shadow-2xl shadow-black/20">
      <div className="grid gap-0 lg:grid-cols-[1fr_.9fr]">
        <div className="p-7 md:p-8">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link href="/upload" className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-amber px-5 py-3 font-bold text-black hover:bg-brand-gold">
