        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-elevation-2 md:p-12">
          <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-2xl bg-primary px-7 py-4 text-lg font-bold text-primary-foreground shadow-elevation-2 hover:bg-primary/90"
            >
