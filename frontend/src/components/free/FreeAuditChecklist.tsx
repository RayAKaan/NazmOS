...
export function FreeAuditChecklist() {
  return (
    <div className="overflow-hidden rounded-3xl border border-white/10 bg-[#0A0E0C] text-white shadow-2xl shadow-black/20">
      <div className="grid gap-0 lg:grid-cols-[1.15fr_.85fr]">
        <div className="p-6 md:p-7">
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-4">
            {steps.map(([Icon, title, body], i) => (
              <div key={title} className="rounded-2xl bg-white/[0.04] p-4 ring-1 ring-white/5">
                <Icon className="mb-3 h-5 w-5 text-[#13A05A]" />
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Link href="/upload" className="inline-flex justify-center rounded-xl bg-[#E0B34A] px-5 py-3 font-bold text-black hover:bg-[#f2cf69]">
              Start Free Audit
            </Link>
        ...
        <div className="border-t border-white/10 bg-white/[0.03] p-6 md:p-7 lg:border-l lg:border-t-0">
          ...
          <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4">
            <div className="flex items-start gap-3">
              <LockKeyhole className="mt-0.5 h-5 w-5 text-[#13A05A]" />
              <div>
