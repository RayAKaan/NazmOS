  ...
  return (
    <main className="min-h-screen bg-[#0A0E0C] px-5 py-12 text-[#F4EFE6] md:px-8">
      <div className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-white/[0.03] p-6 md:p-10">
        <p className="font-mono text-xs uppercase tracking-[0.24em] text-[#E0B34A]">Nazmak pilot terms</p>
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-white/68">
          <section>
            <h2 className="text-xl font-bold text-white">1. Product scope</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white">2. Audit estimates</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white">3. Merchant responsibility</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white">4. Recovery Match limitations</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white">5. Excluded categories</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white">6. Pilot support</h2>
