    ...
    <main className="min-h-screen bg-brand-night px-5 py-12 text-brand-cream md:px-8">
      <div className="mx-auto max-w-3xl rounded-3xl border border-brand-cream/10 bg-brand-cream/[0.03] p-6 md:p-10">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-brand-cream/68">
          <section>
            <h2 className="text-xl font-bold text-brand-cream">1. Data we collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-cream">2. Why we use it</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-cream">3. File handling</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-cream">4. Recovery Match</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-cream">5. Access</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-cream">6. Contact</h2>
