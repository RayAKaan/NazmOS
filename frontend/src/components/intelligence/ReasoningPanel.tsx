    ...
    <div className={cn("space-y-4", className)}>
      ...
      {decision && (
        <div className="rounded-xl border border-intelligence-border bg-intelligence-surface/40 p-4">
          ...
          <p className="font-semibold text-text-primary">{decision.title || decision.action_type}</p>
      ...
      {sources && sources.length > 0 && (
        <div>
          <div className="text-xs uppercase tracking-wider text-text-muted mb-2">Sources</div>
