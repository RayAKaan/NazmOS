...
export function MerchantHelpWidget() {
  ...
  return (
    <div className="fixed bottom-24 right-4 z-50 md:bottom-6">
      {open && (
        <div className="mb-3 w-[min(92vw,360px)] rounded-3xl border border-brand-cream/10 bg-brand-night p-4 text-brand-cream shadow-2xl shadow-brand-night/40">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-brand-cream/60">
            ...
            <button onClick={() => setOpen(false)} className="rounded-full p-1 text-brand-cream/50 hover:bg-brand-cream/10 hover:text-brand-cream" aria-label="Close help">
              <X className="h-4 w-4" />
            </button>
          </div>

          <div className="mt-4 rounded-2xl bg-brand-cream/[0.04] p-3 text-xs leading-5 text-brand-cream/55 ring-1 ring-brand-cream/5">
            <p>Common issues:</p>
          ...
          <button
            onClick={copyMessage}
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-brand-amber px-4 py-3 text-sm font-bold text-brand-night hover:bg-brand-gold"
          >
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-full border border-brand-amber/40 bg-brand-night px-4 py-3 text-sm font-bold text-brand-amber shadow-2xl shadow-brand-night/30 hover:bg-brand-amber hover:text-brand-night"
      >
